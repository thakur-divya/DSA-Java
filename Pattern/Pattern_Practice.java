public class Pattern_Practice {
    ...
    public static void main(String args[]){
        ...
        System.out.println("8th Pattern ButterFly Pattern");
        int num = 4;
        //1st halves
        for(int i=1;i<=num;i++){
            //Stars - i
        ...
        System.out.println("9th Pattern Solid Rhombus Pattern");
        for(int i=1;i<=5;i++){
            for(int j=1;j<=5-i;j++){
                System.out.print(" ");
            }
        ...
        System.out.println("10th Pattern Hollow Rhombus Pattern");
        for(int i=1;i<=5;i++){
            for(int j=1;j<=5-i;j++){
                System.out.print(" ");
            }
